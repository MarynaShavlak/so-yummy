export const theme = {
  ...
  shadows: {
    base: '0px 4px 48px rgba(0, 0, 0, 0.1)',
    select: '0px 6.51852px 7.82222px rgba(0, 0, 0, 0.0314074)',
    switchBody: 'inset 0px 6px 8px 3px rgba(0, 0, 0, 0.1)',
    mainTitle: '0px 4px 4px rgba(0, 0, 0, 0.25)',
    paginationList: '0px 4px 4px rgba(135, 135, 135, 0.2)',
  },
